"""src/dataset/real/sx_superuser.py — StackExchange SuperUser 数据集预处理

数据来源：SNAP https://snap.stanford.edu/data/sx-superuser.html
...
class SXSuperUserDataset(TemporalDataset):
    ...
    def process(self) -> None:
        raw_path = self.raw_dir / "sx-superuser" / "sx-superuser.txt"
        ...
        print(f"[SX-SuperUser] 预处理完成：{n_nodes} 节点，{len(edges)} 边")
